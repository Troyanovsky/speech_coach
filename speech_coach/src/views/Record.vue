  ...
  >
    ...
    >
      <svg
        ...
        class="h-6 w-6 stroke-neutral ml-6"
        fill="none"
        viewBox="0 0 24 24"
        stroke-width="2"
      >
      ...
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6 stroke-neutral mr-6 invisible"
        fill="none"
        viewBox="0 0 24 24"
        stroke-width="2"
      >
    ...
    >
      <div class="h-16 w-16 flex flex-col items-center justify-center m-auto">
        ...
        <div class="text-primary">Record</div>
      </div>
      <div class="h-16 w-16 flex flex-col items-center justify-center m-auto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-6 w-6 stroke-neutral"
          fill="none"
          viewBox="0 0 24 24"
          stroke-width="2"
        >
        ...
        <div class="text-neutral">Result</div>
      </div>
      <div class="h-16 w-16 flex flex-col items-center justify-center m-auto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    -->
    <TabBarVue currentPage="Record"></TabBarVue>
  </div>
</template>
